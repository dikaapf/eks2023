<div class="row col-md-12 ini_bodi">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <a href="#" onclick="return aktifkan_semua_peserta();" class="btn btn-info" style="margin-bottom: 10px"><i class="fa fa-users"></i> Aktifkan semua peserta</a>
          ...
          <form name="f_siswa" id="f_siswa" onsubmit="return m_siswa_s();">
            <input type="hidden" name="id" id="id" value="0">
              <table class="table table-form">
                ...
                <tr><td style="width: 25%">Username</td><td style="width: 75%"><input type="text" class="form-control" name="nim" id="nim" required></td></tr>
                <tr><td style="width: 25%">Kategori</td><td style="width: 75%"><input type="text" class="form-control" name="jurusan" id="jurusan" required></td></tr>
              </table>
      </div>
